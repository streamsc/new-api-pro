...
| `.5` GitHub Release | Passed: [run 34079619869](https://github.com/streamsc/new-api-pro/actions/runs/34079619869), four binaries and three checksum files published from `abfde8c0b5afd88ea784166128f248b5d1fe30fe`; binary checksums match GitHub asset digests |
| `.5` GHCR publication | Passed: [run 34079619819](https://github.com/streamsc/new-api-pro/actions/runs/34079619819), OCI index `sha256:a22b1e4a92da2d61ec00d4256fe36d4484107a69bbbc4ddba478379508612082`; amd64/arm64 smoke, provenance and runtime configuration checks passed, and platform/index Cosign signing completed |
